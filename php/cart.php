...
<html>
    ...
    <body>
        <?php
            ...
            $cart_display_query = "select * from items inner join users_items on items.item_id = users_items.item_id where users_items.user_id = '$user_id' and users_items.status = 'added to cart'";
        ...
        ?>
                <center>
                <img src="/myweb/img/cart.jpg" alt="cart image"><br>
                <p><a href="/myweb/index.php">click </a>to add items in the cart!!</p>
                </center>
        <?php
            }
            else 
